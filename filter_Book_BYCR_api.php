...
$mydata = json_decode($data, true);
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            echo '{"state": true, "message":"讀取篩選後資料成功--依收藏排行!", "data":' . json_encode($mydata) . '}';
        } else {
            //查無所對應的資料
